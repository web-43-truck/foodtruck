...
export async function insertLocation(location: string | null): Promise<string> {
...
export async function updateLocationId (location: Location):Promise<string> {
    ...
    await sql`UPDATE location
              SET location_address = ${locationAddress},
...
export async function updateLocationTruckId (location: Location):Promise<string> {

    const {locationTruckId, locationIsActive, locationAddress, locationLat, locationLng, locationSunrise, locationSunset} = location

    await sql`UPDATE locationTruckId
              SET 
...
<<<<<<< HEAD
export async function selectLocationByTruckId(locationTruckId: string): Promise<Location|null> {
=======
...
export async function selectLocationByLocationIsActive(locationIsActive: null): Promise<Location|null> {
    ...
    const rowList = await sql `SELECT location_id, location_truck_id, location_is_active, location_address, location_Lat,
                                   location_Lng, location_sunrise, location_sunset FROM location WHERE location_is_active = ${locationIsActive}`
...
export async function selectLocationByLocationAddress(request: e.Request, response: e.Response): Promise<Location | null> {
    ...
    const rowList = await sql `SELECT location_id, location_truck_id, location_is_active, location_address, location_Lat,
                                   location_Lng, location_sunrise, location_sunset FROM location WHERE location_address = ${locationAddress}`
...
export async function selectLocationByLocationLat(locationLat: string): Promise<Location|null> {
    ...
    const rowList = await sql `SELECT location_id, location_truck_id, location_is_active, location_address, location_Lat,
                                   location_Lng, location_sunrise, location_sunset FROM location WHERE location_lat = ${locationLat}`
...
export async function selectLocationByLocationLng(locationLng: string): Promise<Location|null> {
    ...
    const rowList = await sql `SELECT location_id, location_truck_id, location_is_active, location_address, location_Lat,
                                   location_Lng, location_sunrise, location_sunset FROM location WHERE location_lng = ${locationLng}`
...
export async function selectLocationByLocationSunrise(locationSunrise: string): Promise<Location|null> {
    ...
    const rowList = await sql `SELECT location_id, location_truck_id, location_is_active, location_address, location_Lat,
                                   location_Lng, location_sunrise, location_sunset FROM location WHERE location_sunrise = ${locationSunrise}`
...
export async function selectLocationByLocationSunset(locationSunset: string): Promise<Location|null> {
    ...
    const rowList = await sql `SELECT location_id, location_truck_id, location_is_active, location_address, location_Lat,
                                   location_Lng, location_sunrise, location_sunset FROM location WHERE location_sunset = ${locationSunset}`
